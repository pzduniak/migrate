...
import (
    ...
    _ "github.com/pzduniak/migrate/database/postgres"
    _ "github.com/pzduniak/migrate/source/github"
)
...
import (
    ...
    _ "github.com/lib/pq"
    "github.com/pzduniak/migrate"
    "github.com/pzduniak/migrate/database/postgres"
    _ "github.com/pzduniak/migrate/source/file"
)
...
--------|------------|--------|------
**master** | :white_check_mark: | `import "github.com/pzduniak/migrate"` | New features and bug fixes arrive here first |
**v4** | :white_check_mark: | `import "github.com/pzduniak/migrate"` | Used for stable releases |
